...
words = [["hi","hay","day","had","lay","dal","holi","lad","lid","hold","lady","hail"],

         ["go","an","in","pro","no","on","map","mom","min","man","gap","gag","gram","pig","man","ping",

          "pong","pram","prom","ramp"],

         ["am","at","to","cab","cap","cat","cob","cop","map","mop","act","bat","boat","camp",

          "comb","boom","pact","atom"],

         ["of","at","or","to","low","caw","cow","char","how","who","calf","claw","flaw","flow",

          "fowl","flow","wolf","crow","half"],
